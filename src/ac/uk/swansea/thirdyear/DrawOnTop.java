/***************************************************************************************************/
/* This class draws the colour a breakdown of the RGB histograms on an image. Instantiated in      */
/* ActivityColorHistogram.java                                                                      */
/* Taken as is from:http://www.stanford.edu/class/ee368/Android/ViewfinderEE368/ViewfinderEE368.java*/                                                                              
/****************************************************************************************************/
...
public class DrawOnTop extends View {
    ...
    public DrawOnTop(Context context, Bitmap bi) {
        super(context);
    ...
    protected void onDraw(Canvas canvas) {
        if (mBitmap != null)
        {
            ...
            canvas.drawBitmap(myBitmap, src, dst, mPaintBlack);
            ...
            float barMaxHeight = 6000;
            float barWidth = ((float)newImageWidth) / 256;
            float barMarginHeight = 2; //2
            RectF barRect = new RectF();
            barRect.bottom = canvasHeight - 300; //200
